...
class LiveTourismCard {
  Widget buildTourismCard(
    Color primaryDark,
    BuildContext context,
    List<Map<String, dynamic>> spots,
    String? municipalName,
    int municipalZipCode,
  ) {
    return Column(
          ...
          child: Row(
            ...
            children: [
              Column(
                ...
                children: [
                  Text(
                    "Discover ${municipalName ?? "Marinduque"}",
                    style: TextStyle(
                      fontSize: 22,
                  ...
                  Text(
                    "Explore the heartbeat of Marinduque",
                    style: TextStyle(
                      fontSize: 12,
              ...
              ElevatedButton.icon(
                ...
                onPressed: () {
                  Navigator.push(
                    ...
                    MaterialPageRoute(
                      builder: (context) =>
                          TouristSpotMap(municipalZipCode: municipalZipCode),
                    ),
                  );
                },
    ...
    setState(() {
      _floatingHearts.add(
        FloatingHeartParticle(
          ...
          onComplete: () {
            if (mounted) {
              setState(() => _floatingHearts.removeWhere((w) => w.key == id));
            }
          },
        ),
      );
    ...
    final detailsPanel = Container(
      ...
      decoration: BoxDecoration(
        color: Colors.white.withValues(
          alpha: widget.performanceMode ? 0.9 : 0.7,
        ),
    ...
    return RepaintBoundary(
      child: Container(
        ...
        margin: EdgeInsets.only(
          right: widget.performanceMode ? 0 : 18,
          bottom: widget.performanceMode ? 0 : 20,
        ),
        decoration: BoxDecoration(
          borderRadius: BorderRadius.circular(28),
          boxShadow: [
            BoxShadow(
              color: const Color(0xFF0A2E5C).withValues(alpha: 0.12),
              blurRadius: 20,
                ...
                child: InkWell(
                  ...
                  onTap: () {
                    Navigator.push(
                      ...
                      MaterialPageRoute(
                        builder: (context) =>
                            TouristSpotDetails(spotData: widget.spot),
                      ),
                    ).then((_) {
                      _fetchLikeCount();
                    });
...
class _FloatingHeartParticleState extends State<FloatingHeartParticle>
    with SingleTickerProviderStateMixin {
  late AnimationController _controller;
