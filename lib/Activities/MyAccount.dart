...
class _MyAccountState extends State<MyAccount> {
    ...
    try {
      ...
      if (mounted) {
        setState(() {
          ...
          _accountStatus = (userData['account_status'] ?? 'un_verified').toString();
          _isLoading = false;
        });
      }
    } catch (e) {
                ...
                children: [
                  ...
                  _buildSettingsGroup([
                    _buildSettingsTile(
                      ...
                      onTap: () => _openLink('https://myaccount.google.com/'),
                    ),
                    ...
                    _buildSettingsTile(
                      ...
                      subtitleColor: const Color(0xFF10B981), // Green color for "Free"
                      onTap: () {
                        Navigator.push(
                          context,
                      ...
                      if (_userRoles.contains("maritime")) ...[
                        _buildSettingsTile(
                          ...
                          onTap: () {
                            Navigator.push(
                              context,
                              MaterialPageRoute(builder: (_) => MaritimeAdministrator()),
                            );
                          },
                        ),
                        if (_userRoles.contains("tourism") || _userRoles.contains("mdrrmo")) _buildDivider(),
                      ],
                      ...
                      if (_userRoles.contains("tourism")) ...[
                        _buildSettingsTile(
                          ...
                          onTap: () {
                            Navigator.push(
                              context,
                              MaterialPageRoute(builder: (_) => TourismAdministrator()),
                            );
                          },
                        ),
                        if (_userRoles.contains("mdrrmo")) _buildDivider(),
                      ],
                      ...
                      if (_userRoles.contains("mdrrmo")) ...[
                        _buildSettingsTile(
                          ...
                          onTap: () {
                            Navigator.push(
                              context,
                              MaterialPageRoute(builder: (_) => MdrrmoAdministrator()),
                            );
                          },
                        ),
                        if (_userRoles.contains("mdrrmo_personnel")) _buildDivider(),
                      ],
                      ...
                      if (_userRoles.contains("mdrrmo_personnel")) ...[
                        _buildSettingsTile(
                          ...
                          onTap: () {
                            Navigator.push(
                              context,
                              MaterialPageRoute(builder: (_) => const MdrrmoPersonnelPanel()),
                            );
                          },
                        ),
                      ],
                  ...
                  _buildSettingsGroup([
                    ...
                    _buildSettingsTile(
                        ...
                        onTap: () => _openLink('https://sites.google.com/view/terms-conditions-aga-app/home')
                    ),
          ...
          Container(
            ...
            child: CircleAvatar(
              ...
              child: _avatarUrl == null || _avatarUrl!.isEmpty
                  ? Icon(Icons.person_rounded, size: 46, color: primaryColor.withValues(alpha: 0.5))
                  : null,
            ),
          ),
  ...
  Widget _buildVerificationPill() {
    ...
    final Color base = verified ? const Color(0xFF10B981) : const Color(0xFFF59E0B);
    return Material(
      ...
      child: InkWell(
        ...
        child: Container(
          ...
          child: Row(
            ...
            children: [
              Icon(verified ? Icons.verified_rounded : Icons.gpp_maybe_rounded, color: Colors.white, size: 12),
