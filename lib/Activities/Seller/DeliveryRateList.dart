...
class _DeliveryRateListState extends State<DeliveryRateList> {
  ...
  Future<void> _persistMinOrder(num value) async {
    ...
    final Map<String, dynamic> merged = prev is Map
  ...
  void _editMinOrder() {
    final ctrl = TextEditingController(
      text: _minOrder > 0 ? Utility().formatPrice(_minOrder) : '',
    );
    showDialog(
      context: context,
      builder: (ctx) => AlertDialog(
        ...
        content: Column(
          ...
          children: [
            Text(
              "Buyers must reach this subtotal to checkout with delivery. Set 0 to disable.",
                ...
                Expanded(
                  child: Column(
                    ...
                    children: [
                      ...
                      Text(
                        _minOrder > 0
                            ? "₱${Utility().formatPrice(_minOrder)} minimum subtotal"
                            : "No minimum (tap to set)",
  ...
  void _showAddRateSheet({Map<String, dynamic>? rateItem}) {
    ...
    if (rateItem == null && _deliveryRates.length >= 20) {
      ScaffoldMessenger.of(context).showSnackBar(
        const SnackBar(
          content: Text("You have reached the limit of 20 delivery rates."),
        ),
      );
      return;
    }
                          ...
                          child: _deliveryRates.isEmpty
                              ...
                              ? GridView.builder(
                                  ...
                                  itemBuilder: (context, index) =>
                                      _buildRateCard(_deliveryRates[index]),
                                )
                              : ListView.separated(
                                  padding: const EdgeInsets.all(16),
                                  itemCount: _deliveryRates.length,
          ...
          children: [
            ...
            Expanded(
              child: Column(
                ...
                children: [
                  Text(
                    item['rate_label'] ?? 'Unknown Location',
                    style: TextStyle(
                      fontWeight: FontWeight.w700,
                      color: primaryDark,
                      fontSize: 16,
